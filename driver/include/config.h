...
#ifndef EVB_BOARD_FOR_RING_FREQ
#define EVB_BOARD_FOR_RING_FREQ		TRUE // for EVB clock ring error need using MCU 100ms
#endif

#ifndef EVB_AUTO_DETECT_PORT_BY_PIN
#define EVB_AUTO_DETECT_PORT_BY_PIN	TRUE// for P3^0 pin auto detect port
#endif
...
#define ENABLE_4K_MODE_ALL_DownScaling_1080p	FALSE	// this config is define for TI, for all 4k downscaling
#define ENABLE_4K_MODE_4096x2048_DownScale_To_1920x1080p	FALSE	// for 4096x2048 down to 1920x1080p
...
#define TMDS_162M_LESS_SDR_BIGGER_DDR TRUE 	// FALSE turn on by AndyNien, 20180105
...
#define ALL_USING_DUAL_PORT_OUT FALSE
...
#define Mode_68052_4K_DownScale	TRUE
#endif
...
// MHL Config
//////////////////////////////////////////////////////////////////////////////////////////
#define _ENABLE_IT6805_MHL_FUNCTION_	FALSE   	//turn off by AndyNien 20180105
#define _ENABLE_MHL_SUPPORT_3D_			FALSE	//turn off by AndyNien 20180105
